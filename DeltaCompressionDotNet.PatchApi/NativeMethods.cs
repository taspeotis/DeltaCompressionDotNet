...
namespace DeltaCompressionDotNet.PatchApi
{
    ...
    {
        /// <summary>
        ///     The ApplyPatchToFile function applies the specified delta to the specified source file. The output file is saved under the designated new file name.
        /// </summary>
        ...
        /// </returns>
        /// <remarks>
        ///     http://msdn.microsoft.com/en-us/library/bb417345.aspx#applypatchtofileaw
        /// </remarks>
        [DllImport("mspatcha.dll", CharSet = CharSet.Unicode)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool ApplyPatchToFile(string patchFileName,
                                                   string oldFileName,
                                                   string newFileName,
                                                   uint applyOptionFlags);

        /// <summary>
        ///     The CreatePatchFile function creates a delta from the specified source and target files and write the delta to the designated file name.
        /// </summary>
        ...
        /// </returns>
        /// <remarks>
        ///     http://msdn.microsoft.com/en-us/library/bb417345.aspx#createpatchfileaw
        /// </remarks>
        [DllImport("mspatchc.dll", CharSet = CharSet.Unicode)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool CreatePatchFile(string oldFileName,
                                                  string newFileName,
